      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: "oklch(0.62 0 0)" }}>
          ...
          <section>
            ...
            <p>You may request access to, correction of, or deletion of your personal data at any time by contacting us at <a href="mailto:support@heclus.com" className="underline">support@heclus.com</a>. We will respond within 30 days.</p>
          </section>
          ...
          <section>
            ...
            <p>For privacy-related questions, contact us at <a href="mailto:support@heclus.com" className="underline">support@heclus.com</a>.</p>
          </section>
