  ...
  offers: [
    {
      ...
      price: "40.00",
      priceCurrency: "USD",
      description: "$40 for a full year of access. 20 niches + the full 8-step AI pipeline.",
    ...
    },
    {
      ...
      price: "19.00",
      priceCurrency: "USD",
      description: "5 niches per month, full pipeline, all features.",
      url: `${SITE_URL}/pricing`,
      availability: "https://schema.org/InStock",
    },
    {
      ...
      price: "49.00",
      priceCurrency: "USD",
      description: "Unlimited niches, unlimited video creation, priority queue and support.",
      url: `${SITE_URL}/pricing`,
      availability: "https://schema.org/InStock",
    },
  ],
