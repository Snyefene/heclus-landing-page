  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6" style={{ background: "var(--bg-page, oklch(0.07 0.004 280))" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm mb-12" style={{ color: "oklch(0.72 0 0)" }}>Last updated: July 2026</p>
        ...
        <div className="space-y-4 text-sm leading-relaxed" style={{ color: "oklch(0.62 0 0)" }}>
          ...
          <section className="rounded-xl p-6" style={{ background: "oklch(0.10 0.006 280 / 0.55)", border: "1px solid oklch(1 0 0 / 0.06)" }}>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>You may request a full refund within <strong style={{ color: "oklch(0.78 0 0)" }}>7 days</strong> of your initial purchase, <strong style={{ color: "oklch(0.78 0 0)" }}>provided you have not created any niches on your account</strong>. Creating a niche consumes AI compute and third-party API credits on our side and is therefore treated as use of the Service.</li>
          ...
          <section className="rounded-xl p-6" style={{ background: "oklch(0.10 0.006 280 / 0.55)", border: "1px solid oklch(1 0 0 / 0.06)" }}>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>You may request a full refund within <strong style={{ color: "oklch(0.78 0 0)" }}>14 days</strong> of purchase, <strong style={{ color: "oklch(0.78 0 0)" }}>provided you have not created any niches on your account</strong>. Creating a niche consumes AI compute and third-party API credits on our side and is therefore treated as use of the Service.</li>
